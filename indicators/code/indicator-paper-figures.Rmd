...
SOURCES <- c("chng", "fb-survey", "jhu-csse", "jhu-csse")
SIGNALS <- c("smoothed_outpatient_cli", "smoothed_whh_cmnty_cli",
             "confirmed_incidence_prop", "deaths_incidence_prop")
NAMES <- c("lag", "CHNG-CLI", "CTIS-CLI-in-community", "Cases", "Deaths")
...
pctile_df %>%
  ...
  labs(x = "Days since initial issue",
