...
corrections typically occuring at a sparse subset of locations and times (e.g.,
due to audits or backlogs being cleared, which can result in thousands of cases
or deaths can be added or removed all at once).  This backfill is much more
