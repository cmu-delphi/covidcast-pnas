...
\affil[k]{College of Fine Arts and Department of Psychology, Carnegie Mellon University}

\affil[l]{Department of Statistics, University of California, Davis}
\affil[m]{Microsoft Research New England}
\affil[n]{Department of Statistics, University of British Columbia}
\affil[o]{Department of Statistics, Stanford University}
\affil[p]{Department of Biomedical Data Science, Stanford University}
\affil[q]{Department of Medicine, Stanford University}
\affil[r]{Program in Immunology, Stanford University School of Medicine}
\affil[s]{Department of Biostatistics, University of Washington}
\affil[t]{Heinz College of Information Systems and Public Policy, Carnegie
  Mellon University}
...
% Googlers: SA, SC, DCF, JG, KH, RH, PM, MPO, CS, BYS, BW, SW
\authorcontributions{Author contributions: A.Re., L.B., M.J., A.Ru., J.T., A.C.,
  E.J.C., N.D., D.C.F., A.J.H., S.H., M.J., J.K., W.L.M.K., Z.C.L., L.M., N.L.O.,
  J.C.W., R.R., and R.J.T. obtained and managed data;
  A.Re., J.B., J.F., Z.C.L., L.M., D.J.M., A.P., S.R., D.R., C.S., N.S., R.T.,
  V.V., L.W., B.W., J.C.W,, S.W., R.R., and R.J.T. designed software and
  research;
  A.Re., L.B., M.J., A.Ru., J.T., W.A.S., T.A., A.B., J.B., L.B., A.A.C., A.C.,
  ...
  A.Re., L.B., M.J., A.Ru., J.T., J.B., A.C., E.J.C., N.D., D.C.F., A.G., K.H.,
  ...
  and A.Re., L.B., M.J., A.Ru., J.T., and R.J.T. wrote the paper.
}
...
\equalauthors{\textsuperscript{2}L.B., M.J., A.Ru., and J.T. contributed equally
  to this work.}
...
in the COVIDcast API. This paper focuses on the COVID-19 activity indicators
themselves, describing the data streams, how they are processed and made
publicly available, and insights that can be gained by combining novel data
sources with standard public health surveillance datasets.
...
Altogether, we collect over 170 signals from 12 distinct sources, aggregate and
...
unavailable. The correlations vary over time in complex ways; while some of this
variation is doubtless due to complex changes in public behavior, reporting and
testing practices, and so on, some is also related to changes in overall
COVID-19 case rates. For example, comparing against
Figure~\ref{fig:time_trends_national}, we observe that correlations drop in
February 2021 for several of the signals, matching when COVID cases also sharply
decline. This decline likely caused the heterogeneity in case rates by county to
decline, making it more difficult for any signal to achieve a high correlation
by county.
...
third. There are three noteworthy points:
...
\item As we will discuss below in more detail, public health reporting is often
  subject to delays and backlogs that cause data to be reported with lag.
  Meanwhile, signals such as CTIS-CLI-in-community can be reported with as
  little as 1--2 days of lag. These high correlations hence indicate a high
  correlation with a case value that may have only been officially reported days
  after these signals.
\end{itemize}
...
and audits have regularly discovered misclassified or unreported cases and
deaths, making it valuable to cross-check against external sources not part of
...
thousands of cases and deaths being added or removed.
Figure~\ref{fig:backfill-compare} shows the amount of revision for several
signals, in terms of the 95th percentile of relative change between initial
estimates and revised estimates issued later; this shows that reported deaths
can have large revisions comparable to revisions in claims-based signals. This
backfill is much more difficult to predict, and thus claims data and other
sources may be a useful stand-in while public health reports are aggregated and
corrected.

\begin{figure}[t]
  \includegraphics[width=\columnwidth]{fig/backfill-compare.pdf}
  \caption{95th percentile relative changes between initial values of key
    signals, compared to the final values reported much later. Calculated using
    each day's state-level estimates for the six months between October 15, 2020
    and April 15, 2021; final values were those reported 120 days after the end
    of this period. Even officially reported case and death data can have large
    revisions 30--60 days after initial reporting; much of this is driven by
    individual large revisions affecting specific states and dates, rather than
    systematic changes affecting all states and dates.}
...
companion paper. Revisions to forecast targets, such as cases and deaths, also
complicate the evaluation of forecast models: comparisons of forecasts to the
ground truth may shift when the ground truth is revised weeks later. Only by
systematically tracking revisions can this effect be monitored.
...
Control and Prevention). It also illustrates a geographical disparity: in the
Northeast, actual vaccination rates more closely match vaccine acceptance in
January than they do in the South, where vaccination rates lag overall. While
