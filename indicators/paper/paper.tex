...
signal values, reported 10--90 days after the underlying events, and later
...
change, showing that reported deaths can have large revisions comparable to
revisions in claims-based signals. This backfill is much more difficult to
predict, and thus claims data and other sources may be a useful stand-in while
public health reports are aggregated and corrected.
...
\begin{figure}[t]
  ...
  \caption{The 95th percentiles of relative changes between early reported
    ...
    recorded as of August 13, 2021, 120 days after April 15. Even officially
    reported case and death data can have large revisions 30--60 days or more
    after initial reporting; much of this is driven by individual large
    revisions affecting specific states and dates, rather than systematic
    changes affecting all states and dates.}
