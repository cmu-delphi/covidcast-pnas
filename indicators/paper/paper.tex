...
% Middle authors
\author[i]{Sumit Agrawal}
\author[l]{Wael Al Saeed}
\author[g]{Taylor Arnold}
\author[j]{Amartya Basu}
\author[d]{Jacob Bien}
\author[r]{{\'A}ngel A. Cabrera}
\author[b]{Andrew Chin}
\author[b]{Eu Jing Chua}
\author[b]{Brian Clark}
\author[i]{Sarah Colquhoun}
\author[b]{Nat DeFries}
\author[i]{David C. Farrow}
\author[r]{Jodi Forlizzi}
\author[i]{Jed Grabman}
\author[b]{Samuel Gratzl}
\author[a]{Alden Green}
\author[r]{Robin Han}
\author[i]{Kate Harwood}
\author[a,b]{Addison J. Hu}
\author[i]{Raphael Hyde}
\author[d]{Sangwon Hyun}
\author[l]{Ananya Joshi}
\author[h]{Jimi Kim}
\author[r]{Andrew Kuznetsov}
\author[b]{Wichada La Motte-Kerr}
\author[e,f]{Balasubramanian Narasimhan}
\author[r]{Yeon Jin Lee}
\author[p]{Kenneth Lee}
\author[b]{Zachary C. Lipton}
\author[r]{Michael X. Liu}
\author[k]{Lester Mackey}
\author[b]{Kathryn Mazaitis}
\author[o]{Daniel J. McDonald}
\author[i]{Phillip McGuinness}
\author[i]{Michael P. O'Brien}
\author[a,b]{Natalia L. Oliveira}
\author[a,b]{Pratik Patil}
\author[r]{Adam Perer}
\author[b]{Collin A. Politsch}
\author[l]{Dawn Rucker}
\author[i]{Chris Scott}
\author[s]{Nigam Shah}
\author[n]{Vishnu Shankar}
\author[p]{James Sharpnack}
\author[b]{Dmitry Shemetov}
\author[q]{Noah Simon}
\author[i]{Benjamin Y. Smith}
\author[b]{Vishakha Srivastava}
\author[e,f]{Robert Tibshirani}
\author[e]{Elena Tuzhilina}
\author[b]{Ana Karina Van Nortwick}
\author[a]{Val{\'e}rie Ventura}
\author[a]{Larry Wasserman}
\author[i]{Benjamin Weaver}
\author[m]{Jeremy C. Weiss}
\author[i]{Spencer Whitman}
\author[r]{Kristin Williams}
...
\affil[d]{Department of Data Sciences and Operations, University of Southern California}
\affil[e]{Department of Statistics, Stanford University}
\affil[f]{Department of Biomedical Data Science, Stanford University}
\affil[g]{Linguistics Program, University of Richmond}
\affil[h]{School of Natural Sciences and Mathematics, University of Texas at Dallas}
\affil[i]{Google.org}
\affil[j]{Information Networking Institute, Carnegie Mellon University}
\affil[k]{Microsoft Research New England}
\affil[l]{Computer Science Department, Carnegie Mellon University}
\affil[m]{Heinz College of Information Systems and Public Policy, Carnegie
  Mellon University}
\affil[n]{Program in Immunology, Stanford University School of Medicine}
\affil[o]{Department of Statistics, University of British Columbia}
\affil[p]{Department of Statistics, University of California, Davis}
\affil[q]{Department of Biostatistics, University of Washington}
\affil[r]{Human-Computer Interaction Institute, Carnegie Mellon University}
\affil[s]{Department of Medicine, Stanford University}
...
\cite{SafeGraphSocial, SafeGraphPatterns} and makes them available to researchers
...
in a clearly visible spike in the left-hand panel of
Figure~\ref{fig:bexar_compare} (case data from JHU CSSE, smoothed using a 7-day
trailing average). Meanwhile, Delphi's COVID Trends and Impact Survey averaged
around 350 responses per day in Bexar County over the same time period, and was
able to estimate the fraction of the population who know someone in their
community with COVID-Like Illness (CLI). As we can see in the right-hand panel
of Figure~\ref{fig:bexar_compare}, this signal was not affected by Bexar
County's reporting problems and, as shown in the last subsection, it is (in
general) highly correlated with case rates, providing an alternate stream of
data about COVID activity unaffected by backlogs. Similar reporting problems
have occurred in many jurisdictions across the United States, making it valuable
to cross-check against external sources not part of the same reporting systems.
...
\acknow{We thank Carrie Reed, Matt Biggerstaff, Michael Johansson, Rachel
  ...
  Hal Varian, Brett Slatkin, and others on Google's Surveys team and
  Google.org's CMU-Delphi Fellowship team; Curtiss Cobb and others on Facebook's   
  Demography and Survey Science, Data for Good and Health teams; Alex Smola and
  others at Amazon Web Services; Tim Suther and others at Change Healthcare;
  Paul Nielsen and others at Optum; and John Tamerius and others at Quidel.
  ...
  Learning and Health (CMLH) at Carnegie Mellon University.}         
