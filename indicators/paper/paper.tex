...
indicators in COVID-19 forecasting and hotspot prediction models
...
paper focuses on the COVID-19 activity indicators themselves, describing the
...
companion paper \cite{McDonald:2021}. Revisions to forecast targets, such as
cases and deaths, also complicate the evaluation of forecast models: comparisons
of forecasts to the ground truth may shift when the ground truth is revised
weeks later. Only by systematically tracking revisions can this effect be
monitored.
