...
different states, between June 1 and August 1, 2020. This signal, known as
DV-CLI, is similar to CHNG-CLI and measures outpatient doctor visits about
COVID-related symptoms, but is provided by a different data partner. In each
plot, the rightmost ends of the lines correspond to estimates for the last day
that data are available for each issue date, which are generally the most
tentative estimates, and appear to be significantly biased upward in Arizona in
...
% cases and deaths, also complicate the evaluation of forecast models:
% comparisons of forecasts to the ground truth may shift when the ground truth
% is revised weeks later. Only by systematically tracking revisions can this
% effect be monitored.
