...
\caption{Performance of the AR model re-estimated for state-level, epiweek case incidence. The thin grey lines are the forecasts of other teams.}\label{fig:compare-to-hub}
\end{figure}
...
{\centering \includegraphics[width=\textwidth]{fig/state-level-performance} 

}

\caption{Performance of our models re-estimated for state-level, epiweek case incidence.}\label{fig:state-level-performance}
\end{figure}
