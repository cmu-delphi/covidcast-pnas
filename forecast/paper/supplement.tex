...
\caption{Performance of our models re-estimated for state-level, epiweek case incidence. Our models are colored the same as before. The solid light-blue line is the COVIDhub Ensemble forecast. The thin grey lines are the forecasts of other teams.}\label{fig:compare-to-hub}
\end{figure}
