...
source(here("code", "figures", "results_processing_and_plotting"))
...
```{r data-loading}
actuals <- readRDS(here("data", "actuals.RDS"))
...
hotspots_finalized <- readRDS(here("data", "hotspots_dishonest.RDS")) %>%
  process_res_hotspots() %>%
  filter(forecaster != "gs_inherit")
cases7dav <- readRDS(here("data", "cases7dav.RDS")) %>%
...
all_sigs <- readRDS(here("data", "all_signals_wide_as_of_2020-05-15.RDS"))
...
source(here("code", "tbd", "trajectory_plot_funs.R"))
preds <- readRDS(here("data", "predictions_honest.RDS"))
