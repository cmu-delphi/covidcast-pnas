...
```{r fcast-hot-combo, include=FALSE, fig.width=8, fig.height=4}
leg <- get_legend(fig3)
...
```{r upswing-histogram, include=FALSE, fig.width=12}
up_down_df %>% 
  filter(period != "jm") %>%
  group_by(forecaster, udf) %>%
