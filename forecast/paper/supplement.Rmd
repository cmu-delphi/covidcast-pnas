...
```{r upswing-summary, fig.cap="Average difference between the WIS of the AR model and of the indicator models. The indicator models generally do best during down and flat periods."}
