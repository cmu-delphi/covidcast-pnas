...
\begin{figure}[tb!]
  ...
  \caption{Revision behavior for signals in the New York City HRR from two
    sources. Each colored line corresponds to the data as reported on that
    date. DV-CLI is revised upward throughout the month of December, though the
    amount fades as we look further back in time. In contrast, JHU-CSSE data
    remains ``as reported'' on December 3 until a major correction is made on
    December 31, affecting all data over the period. }
  \label{fig:vintage}
\end{figure}
