...
problem, rendering it ``easy'' when it was once ``hard'', in the absence of
auxiliary information.  Rather, the gains in accuracy offered by the indicator
models appear to be nontrivial, and consistent across modes of analysis, but
modest---and more about tipping the bias-variance tradeoff in our favor than
providing a consistent leading indication of future events.   

[TODO:  Explain how insights from up/down/flat, lagging/leading, etc., are
relevant to this overall arc.  Reiterate the importance of vintage data.  Finish
with something about what's left for future work?  ] 
