...
\significancestatement{Validated forecasting methodology should be a key 
  ...
  such an AR model (properly trained) can already be competitive with top models
...
the case rate series itself. We assess this by inspecting the difference in
