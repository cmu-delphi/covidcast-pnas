...
\significancestatement{Forecasting is a critical element in the public health
  ...
  % all provide a nontrivial boost in accuracy,
  all provide a nontrivial improvement in forecast accuracy,
  though
  their utility generally depends on the pandemic's local dynamics (upswing,
...
We have included a section in the Supplement that examines two assumption-lean
