...
benefits of adding indicators to the AR model are generally less clear
...
overall and provides a higher standard (when asking whether it can be improved 
upon using indicators).  At the HRR level, where the SNR is lower, including the
indicators as additional linear features in the AR model probably delivers a
