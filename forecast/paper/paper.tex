...
\item Google Search Trends for anosmia and ageusia (Google-AA): A measure of 
  ...
  smell or taste), based on Google's Search Trends data set.  
\end{itemize}
...
\cite{GoogleSymptoms}, and see \cite{Klopfen:2020, Vaira:2020} for justification
of the relevance of anosmia or ageusia to COVID-19 infection.
...
\begin{figure}[tb!]
  ...
  \caption{Revision behavior for two signals in the HRR containing New York  
...
after intial publication.  Compared to the revision pattern in the medical
...
Here, and in the following subsections, we will use ``AR'' to refer to the pure
...
\acknow{We thank Matthew Biggerstaff, Logan Brooks, Johannes Bracher, Michael 
  ...
  U01IP001121; gifts from Facebook, Google, McCune, and Optum; the Canadian
  Statistical Sciences Institute; National Sciences and Engineering Research
  Council of Canada (NSERC) RGPIN-2021-02618; and National Science Foundation
  Graduate Research Fellowship Program (NSF GRFP) award DGE175016.}
