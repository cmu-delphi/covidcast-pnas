...
and anticipating future public health resource needs.  A companion paper
...
consideration to align both tasks as best as possible, and because very few
hotspots exist for the several few months of 2021, due to the general and
gradual decline of the pandemic during this period.  
...
model, which strongly rejects (informally speaking) the implicit regularization
hypothesis.
