...
\significancestatement{Forecasting is a critical element of the public health
  ...
  spread some disease process, based on disease activity in the recent
...
key ingredient in effective public health decision making. Through the
...
queries, and survey responses. For each indicator, we ask whether
including it in a simple model leads to improved forecasting
performance relative to a similar model without it. Performance is considered across two tasks
at the state level at a forecasting horizon of up to about one month:
...
backtesting can lead to misleading retrospective evaluations. Our analysis suggests consistent, although
modest, gains in forecasting performance by using these indicators,
and we investigate whether the auxiliary signals are acting as ``leading indicators'' of case rates.
Evaluating forecasters thoroughly and fairly is an important way that
we can learn from this pandemic to do better in the next.
