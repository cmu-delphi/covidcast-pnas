...
highly erratic. Big spikes or other anomalies can occur in the data as reporting
backlogs are cleared, changes in case definitions are made, etc. Groups like JHU 
CSSE then work tirelessly to correct such anomalies (e.g., back-distribute a
huge spike when a reporting backlog is cleared), resulting in highly nontrivial
and unpredictable revisions.  
